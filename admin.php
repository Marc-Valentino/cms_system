...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Audit Logs Section -->
        <div class="content-card" id="audit">
            <div class="card-header">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Nurse Mike Peterson</td>
                            <td>Updated Patient Record #1248</td>
                            <td>192.168.1.87</td>
                            <td>Today, 9:15 AM</td>
                            <td><span class="badge bg-success">Success</span></td>
                        </tr>
                        <tr>
                            ...
                            <td>Created Prescription #458</td>
                            <td>192.168.1.92</td>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <div>Showing 1-5 of 128 logs</div>
                <nav>
                    <ul class="pagination mb-0">
                        <li class="page-item disabled"><a class="page-link" href="#">Previous</a></li>
                        <li class="page-item active"><a class="page-link" href="#">1</a></li>
            ...
            <div class="row mb-4">
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="p-3 bg-light rounded">
                        <div class="small text-muted">Total Revenue (Month)</div>
                        <div class="h4 mb-0">$124,568</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="p-3 bg-light rounded">
                        <div class="small text-muted">Pending Payments</div>
                        <div class="h4 mb-0">$18,245</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="p-3 bg-light rounded">
                        <div class="small text-muted">Insurance Claims</div>
